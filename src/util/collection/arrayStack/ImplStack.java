 ...
 * 
 * Il s'agit d'une pile d'objets de type « dernier entré, premier sorti »
 * (LIFO). Elle n'accepte pas d'éléments marqués « null ».
 * 
...
{
	// Taille par défaut du tableau et valeur utilisé lors d'un
	// agrandissement.
	...
	public int search(Object obj)
	{
		...
		if (obj != null)
		{
			...
			{
				// Si l'objet recherché est égal àcelui courant en i
